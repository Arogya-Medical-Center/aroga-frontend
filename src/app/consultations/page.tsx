...
export default function ConsultationsPage() {
  ...
  // Check if we should auto-start a new consultation
  useEffect(() => {
          ...
          <div className="bg-white rounded-lg shadow-sm border border-neutral-200 p-6">
              ...
              <button
                onClick={() => {
                  const params = new URLSearchParams({
                    ...
                    consultationId: consultation.id || 'new'
                  });
                  window.location.href = `/dashboard/prescription?${params.toString()}`;
                }}
            ...
            {consultation.prescriptions && consultation.prescriptions.length > 0 ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-neutral-500 mb-4">No prescriptions for this consultation yet.</p>
                <button
                  onClick={() => {
                    const params = new URLSearchParams({
                      patientId: consultation.patientId,
...
function PrescriptionDetailsIcon({ className }: { className?: string }) {
  return (
