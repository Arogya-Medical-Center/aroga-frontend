    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 flex items-center justify-center px-8 py-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <h2 className="text-4xl font-bold text-gray-900 mb-2">Doctor Sign In</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="mobile-email" className="block text-sm font-medium text-gray-700 mb-2">
                Email or Medical License Number
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="e.g., doctor@example.com or ML123456"
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/auth/forgot-password/doctor" className="text-sm text-brand hover:text-brand-hover font-medium">
                Forgot Password?
              </Link>
            </div>
          ...
          <p className="text-center text-sm text-gray-600 mt-6">
            ...
            <Link href="/auth/signup/doctor" className="text-brand hover:text-brand-hover font-medium">
              Sign up
            </Link>
          </p>
          </div>
