        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/auth/forgot-password/patient" className="text-sm text-brand hover:text-brand-hover font-medium">
                Forgot Password?
              </Link>
            </div>
          ...
          <p className="text-center text-sm text-gray-600 mt-6">
            ...
            <Link href="/auth/signup/patient" className="text-brand hover:text-brand-hover font-medium">
              Sign up
            </Link>
          </p>
          </div>
